...
// (Lucide: book-open) — user manual entry
export const iconManual = svg`
    <path d="M12 7v14"/>
...
/** Sun — switch back to the light palette. (Lucide: sun) */
...
/** Moon — switch to the dark palette. (Lucide: moon) */
